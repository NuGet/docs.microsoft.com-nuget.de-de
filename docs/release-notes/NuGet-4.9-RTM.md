...
### <a name="dotnet-nuget-push---interactive-gives-an-error-on-mac---7519"></a>„dotnet nuget push --interactive“ löst auf dem Mac eine Fehlermeldung aus. - [#7519](https://github.com/NuGet/Home/issues/7519)
