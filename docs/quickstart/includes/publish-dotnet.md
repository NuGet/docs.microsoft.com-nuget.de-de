1. <span data-ttu-id="3d6bf-101">Navigieren Sie zum Ordner, der die `.nupkg`-Datei enthält.</span><span class="sxs-lookup"><span data-stu-id="3d6bf-101">Change to the folder containing the `.nupkg` file.</span></span>
