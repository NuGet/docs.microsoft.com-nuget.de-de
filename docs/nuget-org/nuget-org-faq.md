...
Weitere Informationen finden Sie unter [Managing package owners on nuget.org (Verwalten von Paketbesitzern auf nuget.org)](../nuget-org/publish-a-package.md#managing-package-owners-on-nugetorg).
...
Wenn Ihr nuget.org-Konto jedoch nicht mit einem Microsoft-Konto verknüpft ist, können Sie die folgenden Schritte ausführen, um dieses Konto in ein Organisationskonto umzuwandeln.
1. **Voraussetzung:** Sie müssen zunächst ein einzelnes Konto auf nuget.org erstellen, das als Administrator für das Organisationskonto fungiert. Wenn Sie noch kein Konto besitzen, [erstellen Sie ein neues auf nuget.org](individual-accounts.md).
...
Befolgen Sie die Schritte im Abschnitt zum [Löschen Ihres Kontos auf nuget.org](#how-to-delete-my-nugetorg-account) und zum [Registrieren eines neuen Kontos](individual-accounts.md), um ein Konto mit einem zulässigen Benutzernamen zu erstellen.
