### <a name="priority-ordering"></a><span data-ttu-id="11bd7-101">Sortieren nach Priorität</span><span class="sxs-lookup"><span data-stu-id="11bd7-101">Priority ordering</span></span>
