...
Um die [`nuget.exe`-CLI](../reference/nuget-exe-cli-reference.md) in der Paket-Manager-Konsole verfügbar zu machen, installieren Sie das Paket [NuGet.CommandLine](https://www.nuget.org/packages/NuGet.CommandLine/) über die Konsole:
