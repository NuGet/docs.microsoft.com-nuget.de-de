...
* Das Paket zu einem OData-Dienst-Endpunkt aus ATOM-feed gewechselt: Wenn Sie ein auf die CTP2-Version von NuGet Upgrade, sicher, dass die folgende URL als Paketquelle hinzugefügt werden: [http://go.microsoft.com/fwlink/?LinkID=204820](http://go.microsoft.com/fwlink/?LinkID=204820).
