...
---
# <a name="44-rtm-release-notes"></a>Anmerkungen zu der Version 4.4 RTM
...
* Der Paketbefehl „dotnet add“ kann leere Zeilen aus einer CSPROJ-Datei entfernen ([#5697](https://github.com/NuGet/Home/issues/5697))
...
* „dotnet pack“ verhält sich unterschiedlich, je nachdem, ob „TargetFramework“ oder „TargetFrameworks“ verwendet wird ([#5281](https://github.com/NuGet/Home/issues/5281))
...
## <a name="link-to-github-issues-fixed-in-44-rtm"></a>Link zu behobenen GitHub-Problemen, die in Version 4.4 RTM behoben werden
